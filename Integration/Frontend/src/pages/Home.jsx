...
<div id='contact'>
    <img src={logo2} style={{width:"13%",marginRight:"45%"}}/>
    <br/><br/>
    <h2 style={{marginRight:"45%"}}> Contact Us</h2>
    <p style={{marginRight:"45%",marginLeft:"35px",color:"black"}}>
        If you have any questions or concerns please contact us at team@finmate.com. We are here to assist you and address any inquiries you may have.
      </p>

    <br/><br/>
    <div class="social">
    <a href="mailto:team@finmate.com" style={{textDecoration:"none",color:"black",fontSize:"20px"}}>
    <img src={d1} style={{width:"8%", paddingRight:"1rem"}}/>
    team@finmate.com</a>
      <br/><br/><br/>

      <a href="https://www.facebook.com/"><img src={facebook} style={{marginLeft:"6%",width:"10%", paddingRight:"2rem"}}/></a>
      <a href="https://www.instagram.com/"><img src={instagram} style={{width:"10%", paddingRight:"2rem"}}/></a>
      <a href="https://twitter.com/"><img src={twitter} style={{width:"10%", paddingRight:"2rem"}}/></a>
      <a href="https://www.youtube.com/"><img src={youtube} style={{width:"10%", paddingRight:"2rem"}}/></a>
      </div>
      </div>
